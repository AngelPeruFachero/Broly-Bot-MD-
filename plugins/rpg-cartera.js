...
let enlace2 = { contextInfo: { externalAdReply: { showAdAttribution: true, mediaUrl: yt, mediaType: 'VIDEO', description: '', title: wm, body: '🥷🏻 *super Broly Bot - WhatsApp* ', thumbnailUrl: await(await fetch(img)).buffer(), sourceUrl: yt }}}
