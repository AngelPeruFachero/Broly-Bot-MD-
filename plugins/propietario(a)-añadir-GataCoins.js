...
if (!txt) throw `${ag}𝙄𝙉𝙂𝙍𝙀𝙎𝙀 𝙇𝘼 𝘾𝘼𝙉𝙏𝙄𝘿𝘼𝘿 𝘿𝙀 𝗕𝗥𝗢𝗟𝗬𝗖𝗢𝗜𝗡𝗦\n\n𝙀𝙉𝙏𝙀𝙍 𝙏𝙃𝙀 𝙉𝙐𝙈𝘽𝙀𝙍 𝙊𝙁 𝗕𝗥𝗢𝗟𝗬𝘾𝙊𝙄𝙉𝙎`
if (isNaN(txt)) throw `${mg}𝙎𝙄𝙉 𝙎𝙄𝙈𝘽𝙊𝙇𝙊𝙎, 𝙎𝙊𝙇𝙊 𝙄𝙉𝙂𝙍𝙀𝙎𝙀 𝙉𝙐𝙈𝙀𝙍𝙊𝙎\n\n𝙉𝙊 𝙎𝙔𝙈𝘽𝙊𝙇𝙎, 𝙅𝙐𝙎𝙏 𝙀𝙉𝙏𝙀𝙍 𝙉𝙐𝙈𝘽𝙀𝙍𝙎`
let brolycoins = parseInt(txt)
let money = brolycoins
let pjk = Math.ceil(brolycoins * pajak)
money += pjk
if (money < 1) throw `${mg}𝙀𝙇 𝙉𝙐𝙈𝙀𝙍𝙊 𝙈𝙄𝙉𝙄𝙈𝙊 𝘿𝙀 𝗕𝗥𝗢𝗟𝗬𝘾𝙊𝙄𝙉𝙎 𝙀𝙎 *1*\n\n𝙏𝙃𝙀 𝙈𝙄𝙉𝙄𝙈𝙐𝙈 𝙉𝙐𝙈𝘽𝙀𝙍 𝙁𝙍𝙊𝙈 𝗕𝗥𝗢𝗟𝗬𝘾𝙊𝙄𝙉𝙎 𝙄𝙎 *1*`
let users = global.db.data.users
//let users = global.db.data.users[who]
users[who].money += gatacoins
m.reply(`╭━━━[ 𝗕𝗥𝗢𝗟𝗬𝘾𝙊𝙄𝙉𝙎 ]━━━⬣\n┃\n┃ღ *PARA | FOR:*\n┃ღ ${text}\n┃┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈\n┃ღ *SE LE AÑADIÓ | NOW YOU HAVE*\n┃ღ *${brolycoins} BrolyCoin(s)*\n┃\n╰━━━━━━━━━━━━━━⬣\n\n${wm}`)}
/*conn.sendHydrated(m.chat, `╭━━━[ 𝗕𝗥𝗢𝗟𝗬𝘾𝙊𝙄𝙉𝙎 🐈 ]━━━⬣\n┃\n┃ღ *PARA | FOR:*\n┃ღ *${text}*\n┃┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈\n┃ღ *SE LE AÑADIÓ | NOW YOU HAVE*\n┃ღ *${Brolycoins} BrolyCoin(s)* 🐈\n┃\n╰━━━━━━━━━━━━━━⬣`, wm, null, md, '𝗕𝗿𝗼𝗹𝘆-𝘽𝙤𝙩-𝙈𝘿', null, null, [
