...
const smsLista2 = () => { return `卐 CREADOR 卐`}
...
//_autosticker.js
const smsAutoStik = () => { return `${lenguajeGB['smsAvisoFG']()}*¿POR QUÉ CARAJO DURA MUCHO?. EL VÍDEO NO DEBE DE DURAR MÁS DE 7 SEGUNDOS.*`} 

//_expired.js
const smsBottem1 = () => { return `*ME VOY DEL GRUPO!!! 🤝 SI QUIERE QUE VUELVA, USE EL COMANDO _#bottemporal_ PARA QUE VUELVA AL GRUPO!!*`} 
...
const smsAfkM2 = () => { return `\n*EL PUTO MOTIVO DE INACTIVIDAD ERA:*\n`} 
const smsAfkM3 = () => { return `⏳ *TIEMPO INACTIVO:*`} 
const smsAfkM4 = () => { return `*¡OYE MRD! NO ETIQUETES A ESTE(A) USUARIO(A)!! ESTÁ INACTIVO(A)*\n`} 
const smsAfkM5 = () => { return `*MOTIVO DE LA INACTIVIDAD AFK:*\n`} 
const smsAfkM6 = () => { return `*MOTIVO DE LA INACTIVIDAD AFK:\nNO ESPECIFICÓ EL PUTO MOTIVO DE INACTIVIDAD*`} 
const smsAfkTime = () => { return [['día(s)'], ['hora(s)'], ['minuto(s)'], ['segundo(s)']] }
const smsAfkResultTime = smsAfkTime()

//afk-afk.js
const smsAfkQ1 = (usedPrefix, command) => { return `${lenguajeGB['smsAvisoMG']()}*¿POR QUÉ CARAJO TE VAS A AUSENTAR?. ESCRIBA EL MOTIVO POR EL CUÁL ESTARÁ INACTIVO (AFK)*\n\n*EJEMPLO:*\n*${usedPrefix + command}* Voy a realizar tarea`} 
const smsAfkQ2 = () => { return `${lenguajeGB['smsAvisoMG']()}*¿POR QUÉ CARAJO DICES?. MÍNIMO 10 CARACTERES DEBE DE SER EL MOTIVO*`} 
...
const smsDemott = () => { return '*¿A QUIÉN CARAJO LE QUITO ADMIN?. EL NÚMERO NO ES VÁLIDO, VUELVA INTENTAR RESPONDA AL MENSAJE DE ALGUIEN O USE COMO EN ESTE EJEMPLO:*\n'}
...
//grupo-kick.js
const smskick1 = () => { return `${lenguajeGB['smsAvisoAG']()}*¿A QUIÉN CARAJO ELIMINO?. ETIQUETE A LA PERSONA O RESPONDA AL MENSAJE DE LA PERSONA QUE QUIERE ELIMINAR*\n\n*EJEMPLO: `}
const smskick2 = () => { return `ELIMINADO(A) 🫵😼`}
const smskick3 = () => { return `NO PUEDO ELIMINAR AL CREADOR DEL GRUPO 🫵😆`}
const smskick4 = () => { return `NO SEAS PENDEJ@, NO ESTÁ EN ESTE GRUPO 👻`}
...
const smsContacto4 = () => { return 'Contacto Oficial de KataBot 🥷🏻'}
